...
$stmt="select id, question, option1, option2, option3, option4, answer from quizpart2 limit $q_no";
...
if($len>0 && $q_no<=$len)
{
       ...
       // echo  $row["option3"];
        ...
        echo "<center>";
    echo "<br><br><a href='quizpart1.php?q_no=".($q_no+1)."&&score=".($score+1)."&&total=".($total+1)."'><input type='button' name = 'Next' value='Next'><br></a>";
echo"</center>";
